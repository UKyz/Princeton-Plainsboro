<div class="top_logo_bar">
	<a href="index.php"><img src="Images/logo1.png" class="logo_header"></a>
	...
	<?php 
		...
		if (isset($_SESSION) and !empty($_SESSION)) {
			if ($_SESSION['type'] == "patient") {
				...
				echo "<img class=\"small_photo\" src=\"Images/cross_close.png\" alt=\"Log out\" title=\"Log out\"></a>\n";
				echo "\t\t<a href=\"appointments.php\" class=\"am_i_this_person\">\n\t\t\t" . $_SESSION['name'];
				echo "<br />\n";
				...
				echo "<a class=\"top_right\" href=\"log_out.php\">";
				echo "<img class=\"small_photo\" src=\"Images/cross_close.png\" alt=\"Log out\" title=\"Log out\"></a>\n";
				echo "\t\t<a href=\"doctor_index.php\" class=\"am_i_this_person\">\n\t\t\t Dr. " . $_SESSION['name'];
				echo "<br />\n";
			...
			if ($_SESSION['type'] == "admin") {
				...
				echo "<a class=\"top_right\" href=\"log_out.php\">";
				echo "<img class=\"small_photo\" src=\"Images/cross_close.png\" alt=\"Log out\" title=\"Log out\"></a>\n";
				echo "\t\t<a href=\"admin_index.php\" class=\"am_i_this_person\">\n\t\t\t" . $_SESSION['name'];
				echo "<br />\n";
	...
	<div class="top_logo_both">
		<a href="appointments.php" class="button-1">
			<div class="eff-1"></div>
			<p>Log in</p>
		</a>
		<a href="sign_up_patient.php" class="button-2">
			<div class="eff-2"></div>
			<p>Sign up</p>
		</a>
	</div>
...
<header class="top_header">
	...
	<nav>
		<ul>
			...
			<li><a href="consultation.php">Consultation Fees</a></li>
